...
my %emoji = (
  ...
  'fountain' => "\x{26F2} ",
  'golf' => "\x{26F3} ",
  'sailboat' => "boat \x{26F5} ",
  'tent' => "\x{26FA} ",
  'fuelpump' => "\x{26FD} ",
  'scissors' => "\x{2702} ",
  'white_check_mark' => "\x{2705} ",
  'airplane' => "\x{2708} ",
  'envelope' => "email \x{2709} ",
  'fist' => "\x{270A} ",
  'raised_hand' => "hand \x{270B} ",
  'v' => "\x{270C} ",
  'pencil2' => "\x{270F} ",
  'black_nib' => "\x{2712} ",
  ...
  'exclamation' => "heavy_exclamation_mark \x{2757} ",
  'heart' => "\x{2764} ",
  ...
  'waxing_gibbous_moon' => "moon \x{1F314} ",
  'full_moon' => "\x{1F315} ",
  ...
  'factory' => "\x{1F3ED} ",
  'izakaya_lantern' => "lantern \x{1F3EE} ",
  ...
  'point_left' => "\x{1F448} ",
  'point_right' => "\x{1F449} ",
  'punch' => "facepunch \x{1F44A} ",
  'wave' => "\x{1F44B} ",
  'ok_hand' => "\x{1F44C} ",
  'thumbsup' => "+1 \x{1F44D} ",
  'thumbsdown' => "-1 \x{1F44E} ",
  'clap' => "\x{1F44F} ",
  'open_hands' => "\x{1F450} ",
  'crown' => "\x{1F451} ",
  'womans_hat' => "\x{1F452} ",
  ...
  'bomb' => "\x{1F4A3} ",
  'zzz' => "\x{1F4A4} ",
  'boom' => "collision \x{1F4A5} ",
  'sweat_drops' => "\x{1F4A6} ",
  'droplet' => "\x{1F4A7} ",
  'dash' => "\x{1F4A8} ",
  'poop' => "shit hankey \x{1F4A9} ",
  'muscle' => "\x{1F4AA} ",
  'dizzy' => "\x{1F4AB} ",
